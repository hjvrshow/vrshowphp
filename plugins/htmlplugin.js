...
function krpanoplugin()
{
    ...
    local.registerplugin = function(krpanointerface, pluginpath, pluginobject)
    {
        ...
        console.log("............Html5 plugin working");
        // first - say hello
        ...
        text.id='floorplan';
        text.setAttribute("display",false);
        text.style.cssText = "width:100%;height:100%;"+
            "display:flex;color:white;background:rgba(10,50,100,0.5);"+
            "align-items:center;justify-content:center;text-align:center;";

            var letsdopos1=location.search.indexOf("id");
        		var letsdopos2=location.search.indexOf("&");
        		if(letsdopos1<0)
                        letsdoid='test';
            else
              if(letsdopos2<0)
                        letsdoid=location.search.substr(letsdopos1+3);
              else
                      letsdoid=location.search.substr(letsdopos1+3,letsdopos2-letsdopos1-3);
        var xmlpath='clients/'.concat(letsdoid).concat('/img/huxing.jpg');
        //text.innerHTML = "<img src=\'img/huxing.jpg\'>";
        text.innerHTML = "<img src=\'".concat(xmlpath).concat("\'>");
    ...
    function action_dosomething()
    {
      ...
      //  krpano.trace(1, "lookat=" + krpano.view.hlookat + " / " + krpano.view.vlookat);
        ...
        //krpano.call("tween(width|height, 0|0)", plugin);

        var text = document.getElementById("floorplan");
        if(text.getAttribute("display")=='true')
        {
          krpano.call("tween(width|height, 0|0)", plugin);
          text.setAttribute("display",false);
          krpano.trace(1, "smaller display=" + text.getAttribute("display"));
        }else {

          krpano.call("tween(width|height, 300|400)", plugin);
          text.setAttribute("display",true);
          krpano.trace(1, "larger display=" + text.getAttribute("display"));
        }
        //text.innerHTML = "";
